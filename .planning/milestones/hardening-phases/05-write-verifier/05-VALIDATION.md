...
| ------------ | --------------------------------------------------------------------------------------------------------------------- | ---------- | ----------- | --------------------------------------------------------------------------------- | ----------- |
| VERIFY-01    | Verifier issues an independent osascript spawn (not in-script read)                                                   | W2 (05-04) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/WriteVerifier.test.ts`    | ❌ W0       |
| VERIFY-01    | Owner-role mutations report `unverified` (not `skipped`) — D-12                                                       | W2 (05-04) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/WriteVerifier.test.ts`    | ❌ W0       |
| VERIFY-02    | Proven mismatch returns `error` envelope with `WRITE_UNVERIFIED_MISMATCH` — D-01/D-02                                 | W2 (05-04) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/WriteVerifier.test.ts`    | ❌ W0       |
| VERIFY-02    | Absent field in read-back is a hard fail — D-08                                                                       | W1 (05-02) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/field-comparator.test.ts` | ❌ W0       |
| VERIFY-02    | Date comparison with ±60s tolerance — D-08                                                                            | W1 (05-02) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/field-comparator.test.ts` | ❌ W0       |
| VERIFY-02    | Tags compared as Set-of-names — D-08                                                                                  | W1 (05-02) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/field-comparator.test.ts` | ❌ W0       |
| VERIFY-02    | Scalars normalized (estimatedMinutes int-round, flagged/sequential bool, note trim, null/undefined/'' unified) — D-08 | W1 (05-02) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/field-comparator.test.ts` | ❌ W0       |
| VERIFY-02    | Read-back failure returns `VERIFY_READBACK_FAILED` error envelope — D-04                                              | W2 (05-04) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/WriteVerifier.test.ts`    | ❌ W0       |
| VERIFY-03    | Success response metadata includes `verification_status: "verified"` on match                                         | W2 (05-04) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/WriteVerifier.test.ts`    | ❌ W0       |
| VERIFY-03    | Dry-run ops get `verification_status: "skipped"` + audit log entry — D-11                                             | W2 (05-04) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/WriteVerifier.test.ts`    | ❌ W0       |
| OMN-119      | Batch route uses same per-item verifier as single route (parity) — D-10                                               | W2 (05-04) | unit        | `npm run test:unit -- tests/unit/tools/unified/verifier/WriteVerifier.test.ts`    | ❌ W0       |
| VERIFY-01+02 | Task create → live read-back confirms field persisted                                                                 | W3 (05-05) | integration | `npm run test:integration -- tests/integration/tools/write-verifier.test.ts`      | ❌ W0       |
