...
`node "$HOME/projects/omnifocus-mcp/probes/archaeology-prefilter.js"` over the last 7 days of transcripts as the first
action — that probe output is the only source of past-session knowledge. Run it before presenting any results.
